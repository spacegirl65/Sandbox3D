...
namespace Sandbox3D::Renderer
{
    ...
    // Direct3D 12 Scene Constant Buffer containing transformation matrices, multi-light array, and ambient data
    ...
    static_assert(sizeof(SceneConstantBuffer) == 1184, "SceneConstantBuffer must be exactly 1184 bytes");
